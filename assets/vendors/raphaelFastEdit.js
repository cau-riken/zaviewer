...
(function (glob, factory) {
    ...
    \*/
    paperproto.image = function (src, x, y, w, h, onerror) {
        var out = R._engine.image(this, src || "about:blank", x || 0, y || 0, w || 0, h || 0, onerror);
        this.__set__ && this.__set__.push(out);
        return out;
    };
    /*\
...
(function (glob, factory) {
    ...
    R._engine.image = function (svg, src, x, y, w, h, onerror) {
        var el = $("image");
...
(function (glob, factory) {
    ...
    R._engine.image = function (vml, src, x, y, w, h, onerror) {
